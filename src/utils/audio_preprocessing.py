...
def visualize_spectrograms(waveform, high_res_spec, low_res_spec, sample_idx=0):
    """Visualize waveform and spectrograms for a sample."""
    ...
    plt.tight_layout()
    plt.savefig(f'spectrogram_comparison_{sample_idx}.png')
    plt.close()
